...
def train_model(train_dl_form,valid_dl_form,model_form_1):
    ...
    for epoch in range(50):
        ...
        if epoch == 1:
            torch.save(model.state_dict(), r'/home/liu/桌面/GuohonngXie/new_RO_MLN/result/parameters/c_new_test016_epoch2.pth')
        if epoch == 4:
            torch.save(model.state_dict(), r'/home/liu/桌面/GuohonngXie/new_RO_MLN/result/parameters/c_new_test016_epoch5.pth')
        if epoch == 9:
            torch.save(model.state_dict(), r'/home/liu/桌面/GuohonngXie/new_RO_MLN/result/parameters/c_new_test016_epoch10.pth')
        if epoch == 19:
            torch.save(model.state_dict(), r'/home/liu/桌面/GuohonngXie/new_RO_MLN/result/parameters/c_new_test016_epoch20.pth')
        if epoch == 29:
            torch.save(model.state_dict(), r'/home/liu/桌面/GuohonngXie/new_RO_MLN/result/parameters/c_new_test016_epoch30.pth')
        if epoch == 39:
            torch.save(model.state_dict(), r'/home/liu/桌面/GuohonngXie/new_RO_MLN/result/parameters/c_new_test016_epoch40.pth')
...
if __name__=="__main__":
    ...
    torch.save(model.state_dict(), r'/home/liu/桌面/GuohonngXie/new_RO_MLN/result/parameters/c_new_test016_epoch50.pth')