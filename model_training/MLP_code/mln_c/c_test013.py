...
def train_model(train_dl_form,valid_dl_form,model_form_1):
    ...
    for epoch in range(50):
        ...
        if epoch == 2:
            torch.save(model.state_dict(), r'/home/liu/桌面/GuohonngXie/new_RO_MLN/result/parameters/c_new_test013_epoch3.pth')
        if epoch == 4:
            torch.save(model.state_dict(), r'/home/liu/桌面/GuohonngXie/new_RO_MLN/result/parameters/c_new_test013_epoch5.pth')
        if epoch == 9:
            torch.save(model.state_dict(), r'/home/liu/桌面/GuohonngXie/new_RO_MLN/result/parameters/c_new_test013_epoch10.pth')
        if epoch == 19:
            torch.save(model.state_dict(), r'/home/liu/桌面/GuohonngXie/new_RO_MLN/result/parameters/c_new_test013_epoch20.pth')
        if epoch == 29:
            torch.save(model.state_dict(), r'/home/liu/桌面/GuohonngXie/new_RO_MLN/result/parameters/c_new_test013_epoch30.pth')
        if epoch == 39:
            torch.save(model.state_dict(), r'/home/liu/桌面/GuohonngXie/new_RO_MLN/result/parameters/c_new_test013_epoch40.pth')
...
if __name__=="__main__":
    ...
    torch.save(model.state_dict(), r'/home/liu/桌面/GuohonngXie/new_RO_MLN/result/parameters/c_new_test013_epoch50.pth')