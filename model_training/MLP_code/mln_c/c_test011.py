...
class Valid_Dataset(torch.utils.data.Dataset):
    ...
    def __init__(self,data_path):
        # load the csv file as a dataframe
        valid_csv = pd.read_csv(data_path)
        valid_csv.dropna(inplace=True)
        valid_csv["C"] = (valid_csv["C"]+1207.7)/3100.3
        valid_csv["x"] = (valid_csv["x"])/0.026853
        valid_csv["y"] = (valid_csv["y"]+0.001514)/0.003028
        valid_csv["z"] = (valid_csv["z"]+0.000545)/0.0109
...
# train the model
def train_model(train_dl_form,model_form_1):
    ...
    for epoch in range(2):
        ...
        if epoch % 1 == 0:
            ...
            # evaluate the model
            R2_valid, mse_valid = evaluate_model(valid_dl,model)
...
if __name__=="__main__":
    ...
    # prepare the data 
    train_data_path = r"/home/liu/桌面/GuohonngXie/new_RO_MLN/data/tarin_data_csv/model_1_10.csv"
    valid_data_path = r"/home/liu/桌面/GuohonngXie/new_RO_MLN/data/valid_data_csv/model_1_10.csv"
    ...
    torch.save(model.state_dict(), 'c_new_test011.pth')