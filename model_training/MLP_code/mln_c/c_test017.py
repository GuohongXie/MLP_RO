...
class MLP(torch.nn.Module):
    ...
    def __init__(self,n_inputs):
        ...
        self.hidden1 = torch.nn.Linear(n_inputs,80)
        torch.nn.init.xavier_uniform_(self.hidden1.weight)
        self.act1 = torch.nn.ReLU()
        # second hidden layer
        self.hidden2 = torch.nn.Linear(80,80)
        torch.nn.init.xavier_uniform_(self.hidden2.weight)
        self.act2 = torch.nn.ReLU()
        #third hidden layer and output
        self.hidden3 = torch.nn.Linear(80,40)
...
def train_model(train_dl_form,valid_dl_form,model_form_1):
    ...
    for epoch in range(50):
        ...
        if epoch == 2:
            torch.save(model.state_dict(), r'/home/liu/桌面/GuohonngXie/new_RO_MLN/result/parameters/c_new_test017_epoch3.pth')
        if epoch == 4:
            torch.save(model.state_dict(), r'/home/liu/桌面/GuohonngXie/new_RO_MLN/result/parameters/c_new_test017_epoch5.pth')
        if epoch == 9:
            torch.save(model.state_dict(), r'/home/liu/桌面/GuohonngXie/new_RO_MLN/result/parameters/c_new_test017_epoch10.pth')
        if epoch == 19:
            torch.save(model.state_dict(), r'/home/liu/桌面/GuohonngXie/new_RO_MLN/result/parameters/c_new_test017_epoch20.pth')
        if epoch == 29:
            torch.save(model.state_dict(), r'/home/liu/桌面/GuohonngXie/new_RO_MLN/result/parameters/c_new_test017_epoch30.pth')
        if epoch == 39:
            torch.save(model.state_dict(), r'/home/liu/桌面/GuohonngXie/new_RO_MLN/result/parameters/c_new_test017_epoch40.pth')
...
if __name__=="__main__":
    ...
    torch.save(model.state_dict(), r'/home/liu/桌面/GuohonngXie/new_RO_MLN/result/parameters/c_new_test017_epoch50.pth')