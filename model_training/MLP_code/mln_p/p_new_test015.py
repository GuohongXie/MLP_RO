...
def train_model(train_dl_form,valid_dl_form,model_form_1):
    ...
    optimizer = torch.optim.Adam(model_form_1.parameters(), lr=1e-5,weight_decay=1e-6)
    # enumerate epochs
    for epoch in range(50):
        ...
        if epoch == 0:
            torch.save(model.state_dict(), r'/home/liu/桌面/GuohonngXie/new_RO_MLN/result/parameters/p_new_test015_epoch1.pth')
        if epoch == 1:
            torch.save(model.state_dict(), r'/home/liu/桌面/GuohonngXie/new_RO_MLN/result/parameters/p_new_test015_epoch2.pth')
        if epoch == 2:
            torch.save(model.state_dict(), r'/home/liu/桌面/GuohonngXie/new_RO_MLN/result/parameters/p_new_test015_epoch3.pth')
        if epoch == 4:
            torch.save(model.state_dict(), r'/home/liu/桌面/GuohonngXie/new_RO_MLN/result/parameters/p_new_test015_epoch5.pth')
        if epoch == 9:
            torch.save(model.state_dict(), r'/home/liu/桌面/GuohonngXie/new_RO_MLN/result/parameters/p_new_test015_epoch10.pth')
        if epoch == 19:
            torch.save(model.state_dict(), r'/home/liu/桌面/GuohonngXie/new_RO_MLN/result/parameters/p_new_test015_epoch20.pth')
        if epoch == 29:
            torch.save(model.state_dict(), r'/home/liu/桌面/GuohonngXie/new_RO_MLN/result/parameters/p_new_test015_epoch30.pth')
        if epoch == 39:
            torch.save(model.state_dict(), r'/home/liu/桌面/GuohonngXie/new_RO_MLN/result/parameters/p_new_test015_epoch40.pth')
...
if __name__=="__main__":
    ...
    torch.save(model.state_dict(), r'/home/liu/桌面/GuohonngXie/new_RO_MLN/result/parameters/p_new_test015_epoch50.pth')