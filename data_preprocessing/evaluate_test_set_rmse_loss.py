...
if __name__=="__main__":
    ...
    #设置参数路径
    model_state_dict_path_u  = r"../results/model_parameters/all/"
    model_state_dict_path_p  = r"../results/model_parameters/all/"
    model_state_dict_path_c  = r"../results/model_parameters/all/"
