...
if __name__ == '__main__':
    ...
    raw_csv_folder = '../../data/raw_u_csv_all_734/'    
    train_data_save_path = '../../data/train_and_valid_merged_csv_u/train_data_csv/train_data_csv_650.csv' 
    valid_data_save_path = '../../data/train_and_valid_merged_csv_u/valid_data_csv/valid_data_csv_74.csv'
    test_data_save_path = '../../data/train_and_valid_merged_csv_u/test_data_csv/test_data_csv_10.csv'
    set_split_recorder_txt_file_path = '../experiment_record/set_split.txt'
    ...
    with open(set_split_recorder_txt_file_path, 'a') as file_object:
        ...
        print('finished merging valid_data_csv_74', file=file_object)
        file_object.close()
