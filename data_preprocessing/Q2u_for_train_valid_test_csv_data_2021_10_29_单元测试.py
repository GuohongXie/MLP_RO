...
if __name__ == '__main__':
    ...
    df_all_info = pd.read_csv(all_raw_734_info_csv_path,\
                              header = None,\
    ...
    print('#############################测试开始################################')
    testing_csv_path = r'C:\Users\xieg6.DESKTOP-HR7AKB3\Desktop\abc.csv'
    target_path = r'C:\Users\xieg6.DESKTOP-HR7AKB3\Desktop\efg.csv'
    df_t = pd.read_csv(testing_csv_path,\
                              header = None,\
                              names=['x','y','z','D1A','D2A','D1B','D2B','angle','Qtot','Dtot','U','P','C'],\
                              encoding="utf8")  #编码默认UTF-8，若乱码自行更改
    df_t['x'][1:4] = 0
    df_t.to_csv(target_path, header=None, index=False, encoding="utf8")
    print('#############################测试结束################################')
