...
model_state_dict_path_u = r"../../results/model_parameters/all/all_u_4layers_128_64_32_1_Relu_BZ64_LR2e-4_WD1e-7_StepLRSchedule_4_5e-1_noBN_noResnet_noLastRelu_epoch11.pth"
model_state_dict_path_p = r"../../results/model_parameters/all/all_p_4layers_128_64_32_1_Relu_BZ64_LR1e-3_WD1e-7_StepLRSchedule_2_5e-1_noBN_noResnet_noLastRelu_epoch0.pth"
model_state_dict_path_c = r"../../results/model_parameters/all/all_c_4layers_128_64_32_1_Relu_BZ64_LR1e-4_WD1e-7_StepLRSchedule_10_5e-1_noBN_noResnet_noLastRelu_epoch14.pth"
csv_raw_folder = r"../../../data/test_data/all/"
csv_pred_folder = r"../../../data/predict_data/all/" + this_file_name + "/"
print_log_path = r"../../results/predict_processing_log/" + this_file_name + ".txt"
...
predict_all_data_with_two_net_u_p(csv_raw_folder, csv_pred_folder, model_u, model_p, using_gpu=True, which_gpu=0, log_path = print_log_path)
