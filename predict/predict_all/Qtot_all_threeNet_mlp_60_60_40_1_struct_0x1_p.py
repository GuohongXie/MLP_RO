...
model_state_dict_path_p = r"../../results/model_parameters/all/Qtot_all_p_4layers_60_60_40_1_Relu_BZ32_LR1e-4_WD1e-6_noStepLRSchedule_noBN_noResnet_noLastRelu_epoch3.pth"
...
csv_raw_folder = r"../../../data/test_data_Qtot/raw_data_2021_10_29/"
csv_pred_folder = r"../../../data/predict_data_Qtot/all/" + this_file_name + "/"
...
Qtot_predict_all_data_with_three_net_p(csv_raw_folder, csv_pred_folder, model_p, using_gpu=True, which_gpu=0, log_path = print_log_path)
