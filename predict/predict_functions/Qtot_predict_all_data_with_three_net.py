...
def Qtot_predict_all_data_with_three_net(source_csv_folder, target_csv_folder, model_u_used, model_p_used, model_c_used, using_gpu=True, which_gpu=0, log_path = ''):
