...
# model definition
class MLP_Resnet_64_64_64_64_64_1_LastRelu(nn.Module):
    # define model elements
    def __init__(self,n_inputs):
        super(MLP_Resnet_64_64_64_64_64_1_LastRelu,self).__init__()
...
def test():
    net = MLP_Resnet_64_64_64_64_64_1_LastRelu(10)
    x = torch.randn(10)
    y = net(x)
    print(y.size())
